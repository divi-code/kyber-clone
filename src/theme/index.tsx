...
export function colors(darkMode: boolean): Colors {
  return {
    ...
    bg7: darkMode ? '#3169cb' : '#98e5ce',
    bg8: darkMode ? '#1d1d7a' : '#3169cb',
    ...
    bg17: darkMode ? '#3169cb33' : '#3169cb1a',
    ...
    primary5: darkMode ? '#153d6f70' : '#3169cb',

    // color text
    primaryText2: darkMode ? '#a7b6bd' : '#13191b',

    // secondary colors
    secondary1: darkMode ? '#3169cb' : '#3169cb',
    ...
    btnOutline: darkMode ? '#3169cb' : '#333333',
