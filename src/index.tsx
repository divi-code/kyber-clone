...
const ReactApp = ({ hideLoader }: { hideLoader: () => void }) => {
  ...
  return (
    <StrictMode>
      <SEO
        title="SampleSwap - Swap and earn tokens at the best rates"
        description="SampleSwap is DeFi’s first Dynamic Market Maker; a decentralized exchange protocol that provides frictionless crypto liquidity with extremely high flexibility and capital efficiency. SampleSwap is the first major protocol in Sample’s liquidity hub."
      />
      <FixedGlobalStyle />
