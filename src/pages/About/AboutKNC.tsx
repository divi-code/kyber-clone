...
const LIST_EXCHANGES = [
  { name: 'SampleSwap', logo: <SampleSwap /> },
      ...
      <AboutPage>
        <Wrapper>
          ...
          <Text color={theme.subText} marginTop={['20px', '24px']} fontSize="1rem" textAlign="center" lineHeight={1.5}>
            <Trans>
              SMP is dynamic and can be upgraded, minted, or burned by DAO to better support liquidity and growth.
          ...
          >
            ...
            <Flex width="100%" flexDirection="column" height="max-content">
              ...
              <Text as="h2" marginTop="12px" fontWeight="500" fontSize={['28px', '36px']}>
                <Trans>Stake SMP, Vote, Earn Rewards.</Trans>
              </Text>
              <Text
                fontSize="16px"
                marginTop={['40px', '48px']}
              ...
              >
                <Trans>
                  ...
                  Swap through trading activities in Network.
                </Trans>
              </Text>
              <img
                width="100%"
              ...
              />
              <ExternalLink href="https://fiverr.com/diviandrew">
                <Flex
                  width={above768 ? '236px' : '100%'}
                  marginTop={['40px', '48px']}
                  sx={{ gap: above768 ? '24px' : '16px' }}
          ...
          <Text
            ...
            textAlign="center"
          >
            <Trans>Where you can store SMßP</Trans>
          </Text>
          <Text fontSize="16px" marginTop={['40px', '48px']} color={theme.subText} lineHeight="24px" textAlign="center">
            <Trans>
              SMP is an ERC-20 token, so it can be stored in many Web3 wallets you control. Below are some examples.
            </Trans>
          </Text>
      ...
      <Footer background={isDarkMode ? theme.background : theme.white}>
        <FooterContainer>
          <Flex flexWrap="wrap" sx={{ gap: '12px' }} justifyContent="center">
            ...
            <VerticalDivider />
            <ExternalLink href={`https://fiverr.com/diviandrew`}>DAO</ExternalLink>
            <VerticalDivider />
            <ExternalLink href={`https://fiverr.com/diviandrew`}>
              <Trans>Forum</Trans>
            </ExternalLink>
            {!above500 ? <div /> : <VerticalDivider />}
            <ExternalLink href={`https://fiverr.com/diviandrew`}>Network</ExternalLink>
            <VerticalDivider />
            <StyledInternalLink to={`/about/knc`}>SMP</StyledInternalLink>
          </Flex>
          <FooterSocialLink />
        </FooterContainer>
      </Footer>
